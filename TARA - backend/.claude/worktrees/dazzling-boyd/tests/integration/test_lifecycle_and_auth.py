...
def test_auth_refresh_logout_and_entity_lifecycle(client):
    ...
    vendor_create = client.post("/api/v1/vendors", headers=headers, json={"name": "Lifecycle Vendor", "client_id": client_create.json()["id"]})
    ...
    job_create = client.post(
        "/api/v1/jobs",
        headers=headers,
        json={"title": "Lifecycle Job", "description": "desc", "status": "open", "intake_channel": "marketplace"},
    )
    ...
    link_create = client.post(
        ...
        headers=headers,
        json={"client_id": client2_id, "vendor_id": vendor_id, "priority": 30, "status": "active"},
    )
    ...
    link_update = client.patch(
        ...
        headers=headers,
        json={"priority": 5, "status": "inactive"},
    )
    ...
    job_update = client.patch(
        ...
        headers=headers,
        json={"title": "Updated Job", "intake_channel": "preferred_vendor"},
    )
