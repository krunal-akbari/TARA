...
def _to_response(candidate) -> CandidateResponse:
    return CandidateResponse(
        ...
        group_bu=candidate.group_bu,
        current_company=candidate.current_company,
        hr_notes_general=candidate.hr_notes_general,
        hr_notes_status=candidate.hr_notes_status,
        hr_notes_pay=candidate.hr_notes_pay,
        hr_notes_notes=candidate.hr_notes_notes,
...
def update_candidate_endpoint(
    ...
    try:
        updated = update_candidate(
            ...
            group_bu=payload.group_bu,
            current_company=payload.current_company,
            hr_notes_general=payload.hr_notes_general,
            hr_notes_status=payload.hr_notes_status,
            hr_notes_pay=payload.hr_notes_pay,
            hr_notes_notes=payload.hr_notes_notes,
        )
